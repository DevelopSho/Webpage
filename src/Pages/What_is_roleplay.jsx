...
<h3>Závěr</h3>
<p>Pokud vás zaujalo alespoň prvních pár řádků a dočetli jste se až sem, můžete se podívat na náš web a následně vyplnit vstupní formulář. Po jeho vyhodnocení budete přizváni k ústnímu pohovoru z pravidel našeho serveru. Důležitou podmínkou je mít originální verzi hry a následně nainstalovanou adaptaci FiveM. 

Po kliknutí na obrázek můžete navštívit web CMRP a také stránky o FiveM, kde se dozvíte více o této adaptaci a můžete stáhnout launcher pro jejich platformu!</p>
